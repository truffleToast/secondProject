...
<div class ="imageEdit-modal__wrap">
	...
	<div class= "imageEdit-modal imageEdit-modal__aiEraser">
	   ...
	   <form method="post" id="imageEdit-erase__form" enctype="multipart/form-data">
	   ...
	   <input type ="submit" id="imageEdit-erase_sub" value ="AI 지우개">
		</form>
	</div>
...
$(document).ready(function(){
    ...
    $("#imageEdit-makeImg__form").on('submit',function(e){
      ...
      // 이미지와 위치 데이터를 서버에 전송
      $("#imageEdit-erase__form").on("submit",function(e){
    	  e.preventDefault(); // 폼 제출 기본 이벤트 방지
